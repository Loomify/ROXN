...
<div class="css-selector">
  <div class="css-middle">
    <div class="mid-left">
      <h1 style="font-size: 300%;">Coming in the near future</h1>
      <p style="font-size: 125%;">A new product that we call "Zen".</p>
    </div>
  </div>
  <br>
    <div class="mid-right">
      <img src="/images/Xen.png" alt="avnce" width="400" height="400">
    </div>
</div>
</template>
